        ...
        <ion-content>
            ...
            <div class="header">
                <ion-buttons class="back-button">
                    <ion-back-button default-href="/porschelink/appointment" text=""></ion-back-button>
                </ion-buttons>
...
function confirmHour() { router.push({ path: '/porschelink/appointment/booked', query: { date: route.query.date, hour: selectedHour.value } }); } 
</script>
